...
public class MortgageOrientationResultPage {
	...
	private By textLabelMortgagePossible = By.xpath("//span[contains(text(),'Op basis van de gegevens die je hebt ingevuld kan de woning worden gefinancierd met de Moneyou hypotheek.')]");
	...
	private By textLabelMortgagePossibleJoint = By.xpath("//span[contains(text(),'Op basis van de gegevens die jullie hebben ingevuld kan de woning worden gefinancierd met de Moneyou hypotheek.')]");
