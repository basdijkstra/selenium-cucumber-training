...
public class MortgageOrientationResultPage {
	...
	private By textLabelNoMortgagePossible = By.xpath("//p[contains(text(),'Op basis van de gegevens die jullie hebben ingevuld, kan je jouw woning niet financieren met een MoneYou hypotheek.')]");
